...
- Sửa biểu đồ BER: khi điểm đo có BER đúng bằng 0, chỉ giữ điểm zero đầu tiên; các SNR đo sau đó không vẽ marker/đường nữa. Marker zero được tách khỏi polyline, nên đoạn cuối chỉ rơi thẳng đứng xuống sàn log-scale và không còn đoạn ngang dư.
