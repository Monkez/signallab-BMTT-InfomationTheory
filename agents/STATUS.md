...
- Sửa biểu đồ BER: khi điểm đo có BER đúng bằng 0, chỉ giữ điểm zero đầu tiên; các SNR đo sau đó không vẽ marker/đường nữa. Đoạn cuối rơi xuống sàn log-scale tại điểm trước để tránh tạo bậc ngang không cần thiết.
