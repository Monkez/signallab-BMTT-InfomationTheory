...
7. Trong biểu đồ **BER vs SNR**, nhập tên đường, chọn màu và kiểu nét rồi bấm **Save reference** để lưu đường hiện tại. Bấm **Load reference** ngay bên cạnh để mở danh sách và nạp các đường đã lưu; legend cho phép ẩn hoặc xóa từng reference. Các đường được lưu trong trình duyệt của máy và vẫn có thể dùng sau khi mở lại app.
