...
8. Bấm **Details** trên biểu đồ để mở báo cáo BER toàn màn hình. Tab **Chart** mặc định dùng đồ thị SVG độ phân giải cao riêng (viewBox lớn, nhiều vạch trục, nét/chữ không bị phóng từ preview) và legend; tab **Edit & Data** mới chứa danh sách đường, style, bảng SNR/BER/frame/error, thêm/xóa điểm, save và browse/load reference. Modal nằm trên toàn bộ app nên Console không xuất hiện chồng lên báo cáo.
