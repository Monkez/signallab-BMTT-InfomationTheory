...
8. Bấm **Details** trên biểu đồ để mở báo cáo BER toàn màn hình. Tab **Chart** mặc định chỉ tập trung vào đồ thị BER vs SNR lớn và legend; tab **Edit & Data** mới chứa danh sách đường, style, bảng SNR/BER/frame/error, thêm/xóa điểm, save và browse/load reference. Modal nằm trên toàn bộ app nên Console không xuất hiện chồng lên báo cáo.
