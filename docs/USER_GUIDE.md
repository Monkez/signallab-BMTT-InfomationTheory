...
8. Bấm **Details** trên biểu đồ để mở báo cáo BER chuyên sâu, trong đó đồ thị BER vs SNR lớn là khu vực trung tâm. Bên dưới có thể chọn từng đường, chỉnh style, sửa SNR/BER/frame/error theo từng điểm, thêm/xóa điểm, lưu đường đang chọn thành file và browse nạp reference.
