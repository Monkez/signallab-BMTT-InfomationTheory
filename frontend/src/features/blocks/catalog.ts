...
export const fallbackSpecs: BlockSpec[] = [
  ...
  { type: 'symbol_huffman_encode', label: 'Huffman Symbol Encoder', category: 'Source theory', description: 'Huffman for text symbols and P(x)', defaults: { alphabet: 'A,B,C,D', probabilities: '0.5,0.25,0.125,0.125' }, inputs: ['in'], outputs: ['out', 'reference'], gpu_compatible: false },
  { type: 'symbol_huffman_decode', label: 'Huffman Symbol Decoder', category: 'Source theory', description: 'Decode matching text-symbol model', defaults: { alphabet: 'A,B,C,D', probabilities: '0.5,0.25,0.125,0.125' }, inputs: ['in'], outputs: ['out'], gpu_compatible: false },
