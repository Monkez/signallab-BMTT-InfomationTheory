...
export const fallbackSpecs: BlockSpec[] = [
  ...
  { type: 'symbol_shannon_fano_encode', label: 'Shannon-Fano Symbol Encoder', category: 'Source theory', description: 'Shannon-Fano for text symbols', defaults: { alphabet: 'A,B,C,D', probabilities: '0.5,0.25,0.125,0.125' }, inputs: ['in'], outputs: ['out', 'reference'], gpu_compatible: false },
  { type: 'symbol_shannon_fano_decode', label: 'Shannon-Fano Symbol Decoder', category: 'Source theory', description: 'Decode matching symbol model', defaults: { alphabet: 'A,B,C,D', probabilities: '0.5,0.25,0.125,0.125' }, inputs: ['in'], outputs: ['out'], gpu_compatible: false },
